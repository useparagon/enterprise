...
| <a name="input_eks_ondemand_node_instance_type"></a> [eks\_ondemand\_node\_instance\_type](#input\_eks\_ondemand\_node\_instance\_type) | The compute instance type to use for Kubernetes on-demand nodes. | `string` | `"t3a.xlarge"` | no |
...
| <a name="input_eks_spot_node_instance_types"></a> [eks\_spot\_node\_instance\_types](#input\_eks\_spot\_node\_instance\_types) | The compute instance types to use for Kubernetes spot nodes. | `list(string)` | <pre>[<br/>  "t3a.xlarge",<br/>  "t3.xlarge",<br/>  "m5a.xlarge",<br/>  "m5.xlarge",<br/>  "m6a.xlarge",<br/>  "m6i.xlarge",<br/>  "m7a.xlarge",<br/>  "m7i.xlarge",<br/>  "r5a.xlarge",<br/>  "m4.xlarge"<br/>]</pre> | no |
